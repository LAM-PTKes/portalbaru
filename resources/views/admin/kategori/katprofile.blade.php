...
@section('content')
    ...
    <main id="js-page-content" role="main" class="page-content">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item">Kategori Profile</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block"><span>{{ date('d F Y') }}</span></li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-table'></i> Kategori Profile: <span class='fw-300'>Portal WebApp</span>
            </h1>
        </div>
        <div class="row">
            <div class="col-xl-12">
                <div id="panel-1" class="panel">
                    <div class="panel-hdr">
                        <h2>
                            Tabel <span class="fw-300"><i>Kategori Profile</i></span>
                        </h2>
                                ...
                                <tbody>
                                    @foreach ($katpro as $v)
                                        <tr>
                                            ...
                                            <td align="center">
                                                <form action="{{ route('DelKatProfile', $v) }}" method="post"
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-outline-warning edit"
                                                        ...
                                                        value="{{ $v->id }}~{{ $v->katbahasa_id }}~{{ $v->nama_profile }}">
                                            ...
                                            <td align="center">{{ $v->nama_profile }} </td>
    ...
    <div class="modal fade" id="ModalAdd" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('StoKatProfile') }}" method="POST" accept-charset="utf-8" class="was-validated"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="form-label" for="nama_profile">Nama Profile</label>
                            <input type="text" name="nama_profile" id="nama_profile" class="form-control is-valid"
                                required="">
                            <div class="invalid-feedback">Wajib Di isi</div>
                        </div>
    ...
    <div class="modal fade" id="ModalEdit" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('UpKatProfile') }}" method="POST" accept-charset="utf-8" class="was-validated"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="form-label" for="enama_profile">Nama Profile</label>
                            <input type="text" name="enama_profile" id="enama_profile" class="form-control is-valid"
                                required="">
                            <div class="invalid-feedback">Wajib Di isi</div>
                        </div>
