                        ...
                        <ul id="js-nav-menu" class="nav-menu">
                            ...
                            @if(auth()->user()->role == 'Ngadimin' || auth()->user()->role == 'RnD' || auth()->user()->role == 'SPMI' || auth()->user()->role == 'Sekretariat')
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="{{ route('katemail') }}" title="Kategori Email" data-filter-tags="kategori_email">
                                                <span class="nav-link-text" data-i18n="nav.kategori_email">Kategori Email</span>
                                                <i class="fas fa-share fa-2x"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('listemail') }}" title="Daftar Email" data-filter-tags="daftar_email">
                                                <span class="nav-link-text" data-i18n="nav.daftar_email">Daftar Email</span>
                                                <i class="fas fa-share fa-2x"></i>
                                            </a>
                                        </li>
                                    </ul>
