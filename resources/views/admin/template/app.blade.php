...
<head>
    ...
    <link rel="stylesheet" media="screen, print"
        href="{{ asset('admin/dist/css/datagrid/datatables/datatables.bundle.css') }}">
    ...
    <link rel="stylesheet" media="screen, print"
        href="{{ asset('admin/dist/css/formplugins/summernote/summernote-lite.css') }}">
    <link rel="stylesheet" media="screen, print"
        href="{{ asset('admin/dist/css/formplugins/bootstrap-datepicker/bootstrap-datepicker.css') }}">

    <link rel="stylesheet" media="screen, print"
        href="{{ asset('admin/dist/css/notifications/sweetalert2/sweetalert2.bundle.css') }}">
    <link rel="stylesheet" media="screen, print"
        href="{{ asset('admin/dist/css/formplugins/summernote/summernote-lite.css') }}">
    <!-- page related CSS below -->
    <link rel="stylesheet" media="screen, print"
        href="{{ asset('admin/dist/css/formplugins/select2/select2.bundle.css') }}">
...
<body class="mod-bg-1 ">
            ...
            <aside class="page-sidebar">
                <div class="page-logo">
                    <a href="{{ route('dashboard') }}"
                        ...
                        <img src="{{ asset('admin/dist/img/logo.png') }}" alt="Portal WebApp"
                ...
                <nav id="js-primary-nav" class="primary-nav" role="navigation">
                    ...
                    <div class="info-card">
                        ...
                        <img src="{{ asset('admin/dist/img/card-backgrounds/cover-2-lg.png') }}" class="cover"
                            alt="cover">
                    ...
                    <ul id="js-nav-menu" class="nav-menu">
                        ...
                        @if (auth()->user()->role == 'Ngadimin' || auth()->user()->role == 'Sekretariat' || auth()->user()->role == 'Akreditasi')
                            <li>
                                <a href="{{ route('unduhan') }}" title="File Unduhan"
                                    data-filter-tags="File Unduhan">
                            ...
                            <li>
                                <a href="#" title="Hasil Akreditasi" data-filter-tags="Hasil Akreditasi">
                                    ...
                                    <span class="nav-link-text" data-i18n="nav.Hasil Akreditasi">Hasil
                                        Akreditasi</span>
                                </a>
                                <ul>
                                    <li>
                                        <a href="{{ route('akreditasi') }}" title="Publish Hasil Akreditasi"
                                            data-filter-tags="Publish Hasil Akreditasi">
                                            <span class="nav-link-text"
                                                data-i18n="nav.Publish Hasil Akreditasi">Publish</span>
                                            <i class="fas fa-eye fa-2x"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('unpublishhasilakre') }}" title="Unpublish Hasil Akreditas"
                                            data-filter-tags="Unpublish Hasil Akreditas">
                                            <span class="nav-link-text"
                                                data-i18n="nav.Unpublish Hasil Akreditas">Unpublish</span>
                                            <i class="fas fa-eye-slash fa-2x"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('addsimak') }}" title="Add SIMAk"
                                            data-filter-tags="Add SIMAk">
                        ...
                        @if (auth()->user()->role == 'Ngadimin' || auth()->user()->role == 'Sekretariat')
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="{{ route('bahasa') }}" title="Bahasa"
                                            data-filter-tags="kategori_bahasa">
                                            <span class="nav-link-text" data-i18n="nav.kategori_">Bahasa</span>
                                            <i class="fas fa-globe fa-2x"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('katberita') }}" title="Berita"
                                            data-filter-tags="kategori_berita">
                                            <span class="nav-link-text" data-i18n="nav.kategori_berita">Berita</span>
                                            <i class="fas fa-newspaper fa-2x"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('katunduhan') }}" title="Unduhan"
                                            data-filter-tags="kategori_unduhan">
                                            <span class="nav-link-text"
                                                data-i18n="nav.kategori_unduhan">Unduhan</span>
                                            <i class="fas fa-download fa-2x"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('KatProfile') }}" title="Profile"
                                            data-filter-tags="kategori_profile">
                                            <span class="nav-link-text"
                                                data-i18n="nav.kategori_profile">Profile</span>
                                            <i class="fas fa-hand-point-left fa-2x"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('KatJabatan') }}" title="Jabatan"
                                            data-filter-tags="kategori_jabatan">
                                            <span class="nav-link-text"
                                                data-i18n="nav.kategori_jabatan">Jabatan</span>
                                            <i class="fas fa-hand-point-left fa-2x"></i>
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="{{ route('berita') }}" title="Publish"
                                            data-filter-tags="berita_publish">
                                            <span class="nav-link-text" data-i18n="nav.berita_publish">Publish</span>
                                            <i class="fas fa-eye fa-2x"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('brtunpublish') }}" title="Unpublish"
                                            data-filter-tags="berita_unpublish">
                                            <span class="nav-link-text"
                                                data-i18n="nav.berita_unpublish">Unpublish</span>
                                            <i class="fas fa-eye-slash fa-2x"></i>
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{ route('ProfilePimpinan') }}" title="Profile"
                                            data-filter-tags="profile_pimpinan">
                                            <span class="nav-link-text" data-i18n="nav.profile_pimpinan">Profile
                                                Pimpinan</span>
                                            <i class="fas fa-hand-point-left fa-2x"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('organ') }}" title="Organisasi"
                                            data-filter-tags="Organisasi">
                                            <span class="nav-link-text" data-i18n="nav.Organisasi">Organisasi</span>
                                            <i class="fas fa-hand-point-left fa-2x"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('ori') }}" title="Orientasi"
                                            data-filter-tags="Orientasi">
                                    ...
                                    <li>
                                        <a href="{{ route('agenda') }}" title="Agenda Kegiatan"
                                            data-filter-tags="Agenda Kegiatan">
                                            <span class="nav-link-text" data-i18n="nav.Agenda Kegiatan">Agenda
                                                Kegiatan</span>
                                            <i class="fas fa-hand-point-left fa-2x"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('capaian') }}" title="Capaian Tahunan"
                                            data-filter-tags="Capaian Tahunan">
                                            <span class="nav-link-text" data-i18n="nav.Capaian Tahunan">Capaian
                                                Tahunan</span>
                                            <i class="fas fa-hand-point-left fa-2x"></i>
                                        </a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="{{ route('testimoni') }}" title="Testimoni"
                                            data-filter-tags="Testimoni">
                                            <span class="nav-link-text" data-i18n="nav.Testimoni">Testimoni</span>
                                            <i class="fas fa-share fa-2x"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('kontak') }}" title="Kontak Kami"
                                            data-filter-tags="Kontak Kami">
                                    ...
                                    <li>
                                        <a href="{{ route('qna') }}" title="Q&A Akreditasi"
                                            data-filter-tags="Q&A Akreditasi">
                                            <span class="nav-link-text" data-i18n="nav.Q&A Akreditasi">Q&A
                                                Akreditasi</span>
                                            <i class="fas fa-share fa-2x"></i>
                                        </a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="{{ route('cover') }}" title="Cover Album Photo"
                                            data-filter-tags="Cover Album Photo">
                                            <span class="nav-link-text" data-i18n="nav.Cover Album Photo">Cover Album
                                                Photo</span>
                                            <i class="fas fa-image"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('photo') }}" title="Album Photo"
                                            data-filter-tags="Album Photo">
                                            <span class="nav-link-text" data-i18n="nav.Album Photo">Album Photo</span>
                                            <i class="fas fa-image"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('video') }}" title="Album Video"
                                            data-filter-tags="Album Video">
                            ...
                            <li>
                                <a href="{{ route('renstra') }}" title="Renstra" data-filter-tags="renstra">
                        ...
                        @if (auth()->user()->role == 'Ngadimin' ||
                                auth()->user()->role == 'RnD' ||
                                auth()->user()->role == 'SPMI' ||
                                auth()->user()->role == 'Sekretariat')
                            <li class="nav-title">Research and Development</li>
                            <li>
                                <a href="{{ route('riset') }}" title="Riset" data-filter-tags="riset">
                                    <i class="fas fa-hand-point-right"></i>
                                    Daftar Riset
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('jurnal') }}" title="Jurnal" data-filter-tags="jurnal">
                                    <i class="fas fa-hand-point-right"></i>
                                    Daftar Jurnal
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('igrafis') }}" title="Info Grafis" data-filter-tags="info_grafis">
                                    <i class="fas fa-hand-point-right"></i>
                                    Info Grafis
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('nletter') }}" title="Newsletter" data-filter-tags="newsletter">
                                    <i class="fas fa-hand-point-right"></i>
                                    Newsletter
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('survey') }}" title="Survey" data-filter-tags="survey">
                                    <i class="fas fa-hand-point-right"></i>
                                    Survey
                                </a>
                            </li>
                            <li>
                                <a href="#" title="Email Broadcast" data-filter-tags="email_broadcast">
                                    <i class="fas fa-envelope"></i>
                                    <span class="nav-link-text" data-i18n="nav.email_broadcast">Email Broadcast</span>
                                </a>
                                <ul>
                                    <li>
                                        <a href="{{ route('katemail') }}" title="Kategori Email"
                                            data-filter-tags="kategori_email">
                                            <span class="nav-link-text" data-i18n="nav.kategori_email">Kategori
                                                Email</span>
                                            <i class="fas fa-share fa-2x"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('listemail') }}" title="Daftar Email"
                                            data-filter-tags="daftar_email">
                                            <span class="nav-link-text" data-i18n="nav.daftar_email">Daftar
                                                Email</span>
                                            <i class="fas fa-share fa-2x"></i>
                                        </a>
                                    </li>
                ...
                <header class="page-header" role="banner">
                    ...
                    <div class="page-logo">
                        <a href="#"
                            class="page-logo-link press-scale-down d-flex align-items-center position-relative"
                            data-toggle="modal" data-target="#modal-shortcut">
                            <img src="{{ asset('admin/dist/img/logo.png') }}" alt=""
                                aria-roledescription="logo">
                    ...
                    <div class="ml-auto d-flex">
                        ...
                        <div>
                            <a href="#" data-toggle="dropdown" title=""
                                ...
                                <img src="{{ asset('web/personal.png') }}" class="profile-image rounded-circle"
                                    alt="">
                            ...
                            <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                    <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                        <span class="mr-2">
                                            <img src="{{ asset('web/personal.png') }}"
    ...
    <nav class="shortcut-menu d-none d-sm-block">
        ...
        <a href="{{ route('logout') }}"
            onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="menu-item btn"
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.js-summernote').summernote({
                height: 200,
                tabsize: 2,
                placeholder: "Note : Mohon Tidak Copas Langsung Dari Website/Word/Excel/Power Poin Dll. Jika Mau Copas, Copas Dulu Ke Notepad/Sticky Note Baru Copas Ke Sini.",
                fontNames: [
                    'Arial', 'Arial Black', 'Calibri', 'Calibri Bold', 'Calibri Italic',
                    'Comic Sans MS', 'Courier New', 'Helvetica Neue', 'Helvetica',
                    'Impact', 'Lucida Grande', 'Lucida Bright', 'Tahoma',
                ...
                callbacks: {
                    ...
                    onPaste: function(e) {
                        ...
                        // ambil teks murni dari clipboard
                        var bufferText = ((e.originalEvent || e).clipboardData || window.clipboardData)
                            .getData('text/plain');

                        // paste sebagai teks plain
