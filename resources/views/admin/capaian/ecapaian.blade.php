                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <form method="post" action="{{ route('capaian.update', $cpt) }}" class="was-validated" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                {{ method_field('PATCH') }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="judul" value="{{ $cpt->judul }}" id="judul" class="form-control is-valid" required="" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" autocomplete="off" name="tahun" class="form-control is-valid" value="{{ date('d-m-Y', strtotime($cpt->tahun)) }}" placeholder="dd-mm-yyyy" id="datepicker" required="">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="katbahasa" id="katbahasa" class="form-control is-valid" required="">
                                        ...
                                        @foreach($katbhs as $bhs)
                                            <option @if($cpt->katbahasa_id == $bhs->id)
