...
<script type="text/javascript">
    ...
    <main id="js-page-content" role="main" class="page-content">
        <ol class="breadcrumb page-breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0);"> Bahasa</a></li>
            <li class="breadcrumb-item">Edit Kategori Bahasa</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block"><span>{{ date('d F Y')}}</span></li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-table'></i> Edit Kategori Bahasa: <span class='fw-300'></span>
            </h1>
        </div>
        <div class="row">
            <div class="col-xl-12">
                <div id="panel-1" class="panel">
                    <div class="panel-hdr">
                        <h2>
                            Form <span class="fw-300"><i>Edit Kategori Bahasa</i></span>
                        </h2>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <form method="post" action="{{ route('bahasa.update', $bhs) }}" class="was-validated">
                                {{ csrf_field() }}
                                {{ method_field('PATCH') }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="namakbhs" value="{{ $bhs->namakbhs }}" id="namakbhs" class="form-control is-valid" required="" >
                                    <div class="invalid-feedback">Wajib Di isi</div>
                                </div>

                                <div class="form-group">
                                    <label class="form-label" for="keterangan">Keterangan</label>
                                    <textarea name="keterangan" id="keterangan" class="form-control is-valid" rows="5" required="">{{ $bhs->keterangan }}</textarea>
                                    <div class="invalid-feedback">Wajib Di isi</div>
                                </div>

                                <center>
                                    <a href="{{ route('bahasa') }}" title="">
