...
<script type="text/javascript">
    ...
    <main id="js-page-content" role="main" class="page-content">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item">Tambah Riset</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block"><span>{{ date('d F Y')}}</span></li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-table'></i> Tambah Riset: <span class='fw-300'></span>
            </h1>
        </div>
        <div class="row">
            <div class="col-xl-12">
                <div id="panel-1" class="panel">
                    <div class="panel-hdr">
                        <h2>
                            Form <span class="fw-300"><i>Tambah Riset</i></span>
                        </h2>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <form method="post" action="{{ route('riset.store') }}" class="was-validated" enctype="multipart/form-data" id="myForm">
                                {{ csrf_field() }}
                                {{ method_field('POST') }}

                                <div class="form-group">
                                    <label class="form-label" for="judul_riset">Judul Riset</label>
                                    <input type="text" name="judul_riset" id="judul_riset" class="form-control is-valid" maxlength="191"  required="" >
                                    <div class="invalid-feedback">Wajib Di isi</div>
                                </div>

                                <div class="form-group">
                                    <label class="form-label" for="pengarang_riset">Pengarang/Oleh</label>
                                    <input type="text" name="pengarang_riset" id="pengarang_riset" class="form-control is-valid" maxlength="191"  required="" >
                                    <div class="invalid-feedback">Wajib Di isi</div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="file_riset" id="file_riset" class="form-control is-valid" accept=".pdf" required="">
                                    <div class="invalid-feedback">Wajib Di isi</div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="gambar_riset" id="gambar_riset" class="form-control is-valid" accept=".png, .jpg, .jpeg" required="">
                                    <div class="invalid-feedback">Wajib Di isi</div>
                                </div>

                                <div class="form-group">
                                    <label class="form-label" for="ringkasan_hasil_riset">Ringkasan Hasil Riset</label>
                                    <textarea name="ringkasan_hasil_riset" id="ringkasan_hasil_riset" class="form-control is-valid js-summernote" required=""></textarea>
