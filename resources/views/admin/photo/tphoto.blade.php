...
<script type="text/javascript">
    ...
    <main id="js-page-content" role="main" class="page-content">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item">Tambah Album Photo</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block"><span>{{ date('d F Y')}}</span></li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-table'></i> Tambah Album Photo: <span class='fw-300'></span>
            </h1>
        </div>
        <div class="row">
            <div class="col-xl-12">
                <div id="panel-1" class="panel">
                    <div class="panel-hdr">
                        <h2>
                            Form <span class="fw-300"><i>Tambah Album Photo</i></span>
                        </h2>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <form method="post" action="{{ route('photo.store') }}" class="was-validated" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                {{ method_field('POST') }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nphoto" id="nphoto" class="form-control is-valid" required="" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" autocomplete="off" name="thn_albump" class="form-control is-valid" placeholder="dd-mm-yyyy" id="datepicker" required="">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="cover_id" id="cover_id" class="select2 form-control w-100 is-valid" required="">
                                        ...
                                        @foreach($cover as $cvr)
                                            <option value="{{ $cvr->id }}">{{ $cvr->nama_cover_id }}</option>
                                        @endforeach
                                    </select>
                                    <div class="invalid-feedback">Wajib Di isi</div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="nama_file[]" multiple="" id="nama_file" class="form-control is-valid" accept=".png, .jpg, .jpeg" required="">
                                    <div class="invalid-feedback">Wajib Di isi</div>
                                </div>
