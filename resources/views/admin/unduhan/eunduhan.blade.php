...
@section('content')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            // Check on change
            $('#katunduhan').on('change', togglePgi);
                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <form method="post" action="{{ route('unduhan.update', $und) }}" class="was-validated"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="judul" id="judul" value="{{ $und->judul }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="jenjang" id="jenjang" class="form-control is-valid" required="">
                                        ...
                                        <option
                                            @if ($und->jenjang == 'S-3') value="S-3" selected="" @else value="S-3" @endif>
                                            S-3</option>
                                        <option
                                            @if ($und->jenjang == 'S-2') value="S-2" selected="" @else value="S-2" @endif>
                                            S-2</option>
                                        <option
                                            @if ($und->jenjang == 'S-1') value="S-1" selected="" @else value="S-1" @endif>
                                            S-1</option>
                                        <option
                                            @if ($und->jenjang == 'D-4') value="D-4" selected="" @else value="D-4" @endif>
                                            D-4</option>
                                        <option
                                            @if ($und->jenjang == 'D-3') value="D-3" selected="" @else value="D-3" @endif>
                                            D-3</option>
                                        <option
                                            @if ($und->jenjang == 'D-2') value="D-2" selected="" @else value="D-2" @endif>
                                            D-2</option>
                                        <option
                                            @if ($und->jenjang == 'D-1') value="D-1" selected="" @else value="D-1" @endif>
                                            D-1</option>
                                        <option
                                            @if ($und->jenjang == 'Gizi') value="Gizi" selected="" @else value="Gizi" @endif>
                                            Gizi</option>
                                        <option
                                            @if ($und->jenjang == 'Sp-2') value="Sp-2" selected="" @else value="Sp-2" @endif>
                                            Sp-2</option>
                                        <option
                                            @if ($und->jenjang == 'Sp-1') value="Sp-1" selected="" @else value="Sp-1" @endif>
                                            Sp-1</option>
                                        <option
                                            @if ($und->jenjang == 'Profesi') value="Profesi" selected="" @else value="Profesi" @endif>
                                            Profesi</option>
                                        <option
                                            @if ($und->jenjang == 'NON-AKADEMIK') value="NON-AKADEMIK" selected="" @else value="NON-AKADEMIK" @endif>
                                            NON-AKADEMIK</option>
                                        <option
                                            @if ($und->jenjang == '-') value="-" selected="" @else value="-" @endif>
                                            -</option>
                                    </select>
                                    <div class="invalid-feedback">Wajib Di isi</div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="bidang_ilmu" id="bidang_ilmu" class="form-control is-valid"
                                        ...
                                        <option
                                            @if ($und->bidang_ilmu == 'Farmasi') value="Farmasi" selected="" @else value="Farmasi" @endif>
                                            Farmasi</option>

                                        <option
                                            @if ($und->bidang_ilmu == 'Gizi') value="Gizi" selected="" @else value="Gizi" @endif>
                                            Gizi</option>

                                        <option
                                            @if ($und->bidang_ilmu == 'Kebidanan') value="Kebidanan" selected="" @else value="Kebidanan" @endif>
                                            Kebidanan</option>

                                        <option
                                            @if ($und->bidang_ilmu == 'Kedokteran') value="Kedokteran" selected="" @else value="Kedokteran" @endif>
                                            Kedokteran</option>

                                        <option
                                            @if ($und->bidang_ilmu == 'Kedokteran Gigi') value="Kedokteran Gigi" selected="" @else value="Kedokteran Gigi" @endif>
                                            Kedokteran Gigi</option>

                                        <option
                                            @if ($und->bidang_ilmu == 'Kedokteran Hewan') value="Kedokteran Hewan" selected="" @else value="Kedokteran Hewan" @endif>
                                            Kedokteran Hewan</option>

                                        <option
                                            @if ($und->bidang_ilmu == 'Keperawatan') value="Keperawatan" selected="" @else value="Keperawatan" @endif>
                                            Keperawatan</option>

                                        <option
                                            @if ($und->bidang_ilmu == 'Kesehatan Masyarakat') value="Kesehatan Masyarakat" selected="" @else value="Kesehatan Masyarakat" @endif>
                                            Kesehatan Masyarakat</option>

                                        <option
                                            @if ($und->bidang_ilmu == 'Kesehatan Lain') value="Kesehatan Lain" selected="" @else value="Kesehatan Lain" @endif>
                                            Kesehatan Lain</option>

                                        <option
                                            @if ($und->bidang_ilmu == '-') value="-" selected="" @else value="-" @endif>
                                            -</option>
                                    </select>
                                    <div class="invalid-feedback">Wajib Di isi</div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="katunduhan" id="katunduhan" class="form-control is-valid" required="">
                                        ...
                                        @foreach ($katundh as $undh)
                                            <option
                                                @if ($und->katunduhan_id == $undh->id) value="{{ $undh->id }}" selected="" @else value="{{ $undh->id }}" @endif>
                                                {{ $undh->namaundh }}</option>
                                        @endforeach
                                    </select>
                                    <div class="invalid-feedback">Wajib Di isi</div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="katbahasa" id="katbahasa" class="form-control is-valid" required="">
                                        ...
                                        @foreach ($katbhs as $bhs)
                                            <option
                                                @if ($und->katbahasa_id == $bhs->id) value="{{ $bhs->id }}" selected @else value="{{ $bhs->id }}" @endif>
                                                {{ $bhs->namakbhs }}</option>
                                        @endforeach
                                    </select>
                                    <div class="invalid-feedback">Wajib Di isi</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="nama_file" id="nama_file" class="form-control is-valid"
                                        accept=".rar, .zip, .pdf, .docx, .doc, .xlsx, .xls, .pptx, .ppt">
                                    <div class="invalid-feedback">Wajib Di isi</div>
                                </div>
