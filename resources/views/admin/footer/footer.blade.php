                                ...
                                <tbody>
                                    @foreach ($footer as $fweb)
                                        <tr>
                                            ...
                                            <td align="center">
                                                <form action="{{ route('footer.destroy', $fweb) }}" method="post"
                                                    id="delete_data_{{ $fweb->id }}">
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}
                                            ...
                                            <td align="center">
                                                ...
                                                @else
                                                    <a href="{{ route('secure.document.folder', ['folder' => 'img', 'filename' => $fweb->nfile]) }}"
                                                        target="blank" title="">
                                                        <img src="{{ route('secure.document.folder', ['folder' => 'img', 'filename' => $fweb->nfile]) }}"
