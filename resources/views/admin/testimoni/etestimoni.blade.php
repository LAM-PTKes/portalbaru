    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-table'></i> Edit Testimoni: <span class='fw-300'></span>
            </h1>
        </div>
        <div class="row">
            <div class="col-xl-12">
                <div id="panel-1" class="panel">
                    <div class="panel-hdr">
                        <h2>
                            Form <span class="fw-300"><i>Edit Testimoni</i></span>
                        </h2>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <form method="post" action="{{ route('testimoni.update', $ttm) }}" class="was-validated" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                {{ method_field('PATCH') }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_lengkap" value="{{ $ttm->nama_lengkap }}" id="nama_lengkap" class="form-control is-valid" required="" >
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="katbahasa" id="katbahasa" class="form-control is-valid" required="">
                                        ...
                                        @foreach($katbhs as $bhs)
                                            <option @if($ttm->katbahasa_id == $bhs->id)
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="jabatan" id="jabatan" class="form-control is-valid" rows="5" required="">{{ $ttm->jabatan }}</textarea>
                                    <div class="invalid-feedback">Wajib Di isi</div>
                                </div>

                                <div class="form-group">
                                    <label class="form-label" for="deskripsi">Deskripsi</label>
                                    <textarea name="deskripsi" id="deskripsi" class="form-control is-valid js-summernote" required="">{{ $ttm->deskripsi }}</textarea>
                                    <div class="invalid-feedback"><i class="fas fa-hand-point-up fa-2x"></i>   Wajib Di isi</div>
                                </div>

                                <center>
                                    <a href="{{ route('testimoni') }}" title="">
