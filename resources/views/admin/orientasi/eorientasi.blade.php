...
<script type="text/javascript">
    ...
    <main id="js-page-content" role="main" class="page-content">
        <ol class="breadcrumb page-breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0);"> Orientasi</a></li>
            <li class="breadcrumb-item">Edit Orientasi LAM-PTKes</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block"><span>{{ date('d F Y')}}</span></li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-table'></i> Edit Orientasi LAM-PTKes: <span class='fw-300'></span>
            </h1>
        </div>
        <div class="row">
            <div class="col-xl-12">
                <div id="panel-1" class="panel">
                    <div class="panel-hdr">
                        <h2>
                            Form <span class="fw-300"><i>Edit Orientasi LAM-PTKes</i></span>
                        </h2>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <form method="post" action="{{ route('ori.update', $ori) }}" class="was-validated" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                {{ method_field('PATCH') }}


                                <div class="form-group">
                                    <label class="form-label" for="norientasi">Nama Orientasi</label>
                                    <input type="text" name="norientasi" id="norientasi" value="{{ $ori->norientasi }}" class="form-control is-valid" required="" >
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="katbahasa" id="katbahasa" class="form-control is-valid" required="">
                                        ...
                                        @foreach($katbhs as $bhs)
                                            <option @if($ori->katbahasa_id == $bhs->id)
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="deskripsi" id="deskripsi" class="form-control is-valid js-summernote" required="">{{ $ori->deskripsi }}</textarea>
                                    <div class="invalid-feedback"><i class="fas fa-hand-point-up fa-2x"></i>   Wajib Di isi</div>
                                </div>

                                <center>
                                    <a href="{{ route('ori') }}" title="">
