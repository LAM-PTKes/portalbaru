...
<script>
    ...
    <main id="js-page-content" role="main" class="page-content">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item">Orientasi LAM-PTKes</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block"><span>{{ date('d F Y')}}</span></li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-table'></i> Orientasi LAM-PTKes: <span class='fw-300'>Portal WebApp</span>
            </h1>
        </div>
        <div class="row">
            <div class="col-xl-12">
                <div id="panel-1" class="panel">
                    <div class="panel-hdr">
                        <h2>
                            Tabel <span class="fw-300"><i>Orientasi LAM-PTKes</i></span>
                        </h2>
                            ...
                            <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                                <thead class="bg-primary-600">
                                    <tr>
                                        ...
                                        <th><center>Nama Orientasi</center></th>
                                        <th><center>Deskripsi</center></th>
                                        <th><center>Kategori Bahasa</center></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach($orientasi as $org)
                                        <tr>
                                            <td align="center">{{ $no++ }}</td>
                                            <td align="center">
                                                <form action="{{route('ori.destroy', $org)}}" method="post" id="delete_data_{{ $org->id }}">
                                                {{ csrf_field() }}                          
                                                {{ method_field('DELETE') }}
                                                    <a href="{{ route('ori.edit', $org) }}">
                                            ...
                                            <td align="justify">{{ $org->norientasi }} </td>
