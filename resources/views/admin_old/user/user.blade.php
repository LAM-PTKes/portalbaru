                            ...
                            <div class="modal fade" id="default-example-modal" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('user.store') }}" method="POST" accept-charset="utf-8" class="was-validated" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            {{ method_field('POST') }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama_lengkap"  id="nama_lengkap" class="form-control is-valid" required="" >
                                ...
                                <tbody>
                                    @foreach($users as $user)
                                        <tr>
                                            ...
                                            <td align="center">
                                                <form action="{{route('user.destroy', $user)}}" method="post" id="delete_data_{{ $user->id }}">
                                                {{ csrf_field() }}                          
                                                {{ method_field('DELETE') }}
                                                    ...
                                                    @if(auth()->user()->role == 'Ngadimin')
                                                        <button type="button" class="btn btn-sm btn-outline-danger" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" onclick="hapus('{{ $user->id }}')">
