                            ...
                            <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                                <thead class="bg-primary-600">
                                    <tr>
                                        ...
                                        <th><center>Kategori Unduhan</center></th>
                                        <th><center>Kategori Bahasa</center></th>
                                        <th><center>File Unduhan</center></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach($unduhan as $und)
                                        <tr>
                                            ...
                                            <td align="center">
                                                <form action="{{route('unduhan.destroy', $und)}}" method="post" id="delete_data_{{ $und->id }}">
                                                {{ csrf_field() }}                          
                                                {{ method_field('DELETE') }}
                                                    ...
                                                    @if(auth()->user()->role == 'Ngadimin')
                                                        <button type="button" class="btn btn-sm btn-outline-danger" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Delete" onclick="hapus('{{ $und->id }}')">
                                            ...
                                            <td > 
                                                <a href="{{ asset('unduhan/'.$und->nama_file) }}" title="" target="blank">
                                                    {{ $und->nama_file }}
                                                </a>
                                            </td>
                                        </tr>
