...
@section('title', 'Detail Berita - LAM-PTKes')
@section('content')
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="title-base text-left">
                        <h1>Detail {{ $new->katberita->namakbrt }}</h1>
                    </div>
                </div>
                <div class="col-md-3">
                    <ol class="breadcrumb b white">
                        ...
                        <li class="active">Detail {{ $new->katberita->namakbrt }}</li>
                    </ol>
                </div>
            </div>
        </div>
	                                ...
	                                <div class="advs-box niche-box-blog">
	                                    <div class="block-top">
	                                        <div class="block-title">
	                                            <h2>{{ $new->judul }}</h2>
	                                            <div class="tag-row">
	                                                <span><i class="fa fa-bookmark"></i> <a href="#">{{ $new->katberita->namakbrt }}</a></span>
