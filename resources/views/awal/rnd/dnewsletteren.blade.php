...
@section('title', 'Details Newsletter of IAAHEH')
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="title-base text-left">
                        <h1>Details Newsletter of IAAHEH</h1>
                    </div>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb b white">
                        ...
                        <li><a href="#">Page</a></li>
                        <li class="active">Details Newsletter of IAAHEH</li>
                    </ol>
                </div>
            </div>
        </div>
                  ...
                  <div class="list-group latest-post-list list-blog">
                        <div class="peny">
                            <h3 class="penny">
                                ...
                                <a href="#" class="rsswidget">Other Newsletters</a>
                            </h3>
                        </div>
                        @foreach($nleter as $v)
                        	<div class="list-group-item">
	                            ...
	                            <a href="{{ route('dnewsleten', $v->id)}}">
	                                <h5>{{ $v->judul }}</h5>
	                            </a>
	                        </div>
                        @endforeach
                    </div>
                     <a href="{{ route('tnewsleten') }}">
                        <i class="fa fa-eye"> <u>Other Newsletters</u></i>
                    </a>
                    <br>
                    <br>
                    <br>
