            ...
            <div class="row">
                <div class="col-md-12">
                    @foreach ($riset as $rst)
                        <div class="advs-box advs-box-side-img advs-box-blog boxed-inverse" data-anima="scale-rotate"
                            data-trigger="hover">
                            <div class="row">
                                <div class="col-md-3">
                                    <a class="img-box">
                                        <img class="anima"
                                            src="{{ route('secure.document.folder', ['folder' => 'riset', 'filename' => $rst->gambar_riset]) }}"
                                            alt="" />
                                    </a>
                                </div>
                                <div class="col-md-9">
                                    ...
                                    <a class="btn btn-sm" href="{{ route('dlpriset', $rst->id) }}">Baca Riset
                                        Selengkapnya</a>
                                </div>
                            </div>
                        </div>
