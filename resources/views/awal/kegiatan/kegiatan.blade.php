...
@section('title', 'Kegiatan - LAM-PTKes')
@section('content')
            ...
            <div class="row">
                                ...
                                <div class="advs-box niche-box-blog">
                                    <div class="block-top">
                                        ...
                                        <div class="block-title">
                                            <h3><a href="{{ route('dagenda', $agenda->id)}}"> {{ $agenda->nagenda }}</a></h3>
                ...
                <div class="col-md-3 col-sm-12 widget">
			            ...
			            <div class="peny">
                            <h3 class="penny">
                              <i class="fa fa-newspaper-o"></i>
                                <a href="#" class="rsswidget">Berita Terpopuler</a>
                            </h3>
                        </div> 
                    ...
                    <a href="{{ route('tberita') }}">
                        <i class="fa fa-eye"> <u>Berita Lainnya</u></i>
                    </a>
                    <br><br><br>
                    <div class="list-group latest-post-list list-blog">
			            <div class="peny">
