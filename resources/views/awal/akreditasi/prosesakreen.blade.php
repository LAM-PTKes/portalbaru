...
@section('title', 'Directory Accreditation Process - IAAHEH')
@section('content')
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="title-base text-left">
                        <h1>Study Program in the Accreditation Process IAAHEH</h1>
                    </div>
                </div>
                <div class="col-md-3">
                    <ol class="breadcrumb b white">
                        ...
                        <li class="active">Accreditation Process</li>
                    </ol>
                </div>
            </div>
        </div>
