...
@section('title', 'Proses Assesmen Kecukupan')
@section('content')
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="title-base text-left">
                        <h1>Proses Assesmen Kecukupan</h1>
                    </div>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb b white">
                        ...
                        <li class="active">Proses Assesmen Kecukupan</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <tbody>
                                @foreach($result as $k => $v)
                                    <tr>
                                        ...
                                        {{-- <td>{{ strtoupper($v['TANGGAL_PENGAJUAN']) }}</td> --}}
