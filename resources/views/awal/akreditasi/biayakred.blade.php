...
@section('title', 'Biaya Akreditasi - LAM-PTKes')
@section('content')
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="title-base text-left">
                        <h1>{{ $biaya->first()->judul ?? '-' }} LAM-PTKes</h1>
                    </div>
                </div>
                <div class="col-md-3">
                    <ol class="breadcrumb b white">
                        ...
                        <li class="active">{{ $biaya->first()->judul ?? '-' }}</li>
                    </ol>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="block-title">
                                            ...
                                            <div class="tag-row">
                                                <span><i class="fa fa-bookmark"></i> <a
                                                        href="{{ route('tbiayakred') }}">{{ $biaya->first()->judul ?? '-' }}</a></span>
