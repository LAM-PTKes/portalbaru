...
@section('title', 'Announcement - IAAHEH')
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb b white">
                        ...
                        <li class="active">Announcement IAAHEH</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <div class="advs-box niche-box-blog">
                                    <div class="block-top">
                                        ...
                                        <div class="block-title">
                                            <h3><a href="{{ route('dpengumen', $v->id) }}"> {!! $v->judul !!}</a></h3>
                                            <div class="tag-row">
                                                <span><i class="fa fa-bookmark"></i> <a href="{{ route('dpengumen', $v->id) }}">{{str_replace('Pengumuman', 'Announcement',  $v->katberita->namakbrt) }}</a></span>
                                                <span>
                                                    <i class="fa fa-pencil"></i>
                                                    <a href="{{ route('dpengumen', $v->id) }}">
                                                        Admin
                                                    </a>
                                                </span>
                                                <span>
