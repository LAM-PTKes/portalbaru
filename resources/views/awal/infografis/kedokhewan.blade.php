        ...
        <div class="card-box table-responsive">
            <table id="key-table4" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Nama Provinsi</th>
                        ...
                        <th>Peringkat B</th>
                        <th>Peringkat C</th>
                        <th>Tidak Terkareditasi</th>
                    </tr>
                </thead>
                <tbody>
                @foreach($kedokhewan as $v)
                    <tr>
                        <td align="center">
                            {{ $no++ }}
                        </td>
...
<script type="text/javascript">
    ...
    // ];
    // Create the chart
    Highcharts.mapChart('kedokhewan', {
        chart: {
            map: 'countries/id/id-all'
        },

        title: {
            text: 'Akreditasi LAM-PTKes Bidang Ilmu Kedokteran Hewan'
        },
