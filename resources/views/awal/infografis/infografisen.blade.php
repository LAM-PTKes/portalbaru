...
@section('title', 'Infographics IAAHEH')
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb b white">
                        ...
                        <li class="active">Infographics IAAHEH</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <label for="bidang ilmu">Group of Knowledge</label>
                            <select name="jenjang" class="form-control" onchange="showDiv(this)" id="bidang ilmu">
                                ...
                                <option value="6">Veterinary Medicine</option>
                                <option value="7">Nursing</option>
                                <option value="8">Public health</option>
                                <option value="9">Other Health</option>
                            </select>
                        </div>
                    </div>
                    <br>
