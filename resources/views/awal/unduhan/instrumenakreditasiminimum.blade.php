...
@section('title', 'Unduhan Instrumen Izin Prodi Baru')
@section('content')
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="title-base text-left">
                        <h1>Unduh Instrumen Izin Prodi Baru</h1>
                    </div>
                </div>
                <div class="col-md-3">
                    <ol class="breadcrumb b white">
                        ...
                        <li class="active">Instrumen Izin Prodi Baru</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card-box table-responsive">
                        ...
                        <table id="key-table" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tr>
                                <th>No</th>
                                <th>Instrumen Izin Prodi Baru</th>
                                <th>Jenjang</th>
                                <th>Bidang Ilmu</th>
                                <th>Deskripsi</th>
                            </tr>
