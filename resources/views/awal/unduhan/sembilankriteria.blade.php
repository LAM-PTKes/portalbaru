...
@section('title', 'Unduhan Instrumen Akreditasi 9 Kriteria')
@section('content')
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="title-base text-left">
                        <h1>Unduh Instrumen Akreditasi 9 Kriteria</h1>
                    </div>
                </div>
                <div class="col-md-3">
                    <ol class="breadcrumb b white">
                        ...
                        <li class="active">Instrumen Akreditasi</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container content">
             <div class="row">
				...
				<th>Tanggal Unggah</th>
                                <th>Unduh Instrumen Akreditasi</th>
                                <th>Jenjang</th>
                                <th>Bidang Ilmu</th>
                            </tr>
                            </thead>
