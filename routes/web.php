...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/admin/kategori/profile', 'KatProfileController@index')->name('KatProfile');
    Route::post('/admin/kategori/profile/store', 'KatProfileController@store')->name('StoKatProfile');
    Route::put('/admin/kategori/profile/update', 'KatProfileController@update')->name('UpKatProfile');
    Route::delete('/admin/kategori/profile/{ktg}/delete', 'KatProfileController@destroy')->name('DelKatProfile');

    Route::get('/admin/jabantan', 'KatProfileController@jabatan')->name('KatJabatan');
    Route::post('/admin/jabantan/store', 'KatProfileController@simpan')->name('StoKatJabatan');
    Route::put('/admin/jabantan/update', 'KatProfileController@edit')->name('UpKatJabatan');
    Route::delete('/admin/jabantan/{jbt}/delete', 'KatProfileController@DelKatJabatan')->name('DelKatJabatan');

    Route::get('/admin/profile/pimpinan', 'ProfilePimpinanController@index')->name('ProfilePimpinan');
    Route::post('/admin/profile/pimpinan/store', 'ProfilePimpinanController@store')->name('StoProfilePimpinan');
    Route::put('/admin/profile/pimpinan/update', 'ProfilePimpinanController@update')->name('UpProfilePimpinan');
    Route::delete('/admin/profile/pimpinan/{ppl}/delete', 'ProfilePimpinanController@destroy')->name('DelProfilePimpinan');

    Route::get('/GetProfile', 'ProfilePimpinanController@GetProfile')->name('GetProfile');
    Route::get('/GetJabatan', 'ProfilePimpinanController@GetJabatan')->name('GetJabatan');
